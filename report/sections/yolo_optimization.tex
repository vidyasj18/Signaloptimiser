...
\begin{figure}[H]
    ...
    \caption{YOLO detection example with bounding boxes highlighting classification outputs clearly.}
...
\begin{figure}[H]
    ...
    \caption{Vehicle type distribution across approaches derived from YOLO counts insights.}
